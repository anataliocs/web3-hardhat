...
contract PsDevs is ERC721Enumerable, Ownable {
    /**
    ...
    /**
      ...
      * Constructor for PS Devs takes in the baseURI to set _baseTokenURI for the collection.
      */
    constructor (string memory baseURI) ERC721("PS Devs", "PSDEV") Ownable(msg.sender) {
